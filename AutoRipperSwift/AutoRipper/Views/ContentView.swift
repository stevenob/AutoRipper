...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ripVM.onRipComplete = { [weak queueVM] name, file, elapsed, resolution, card, mediaResult, intent, editionLabel, season, episode, episodeTitle, discFingerprint, ripReadErrors in
                queueVM?.addJob(discName: name, rippedFile: file, ripElapsed: elapsed, resolution: resolution, card: card, mediaResult: mediaResult, intent: intent, editionLabel: editionLabel, seasonNumber: season, episodeNumber: episode, episodeTitle: episodeTitle, discFingerprint: discFingerprint, ripReadErrors: ripReadErrors)
            }
